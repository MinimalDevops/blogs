...
- [How to build your own Youtube Video Summarizer using Ollama and Streamlit](https://medium.com/how-to-build-your-own-youtube-video-summarizer-using-ollama-and-streamlit-389109454e5f)
- [Understanding Key AI Terms](https://medium.com/understanding-key-ai-terms-6cd73534449e)
...
- [Mutating Webhooks in Kubernetes](https://medium.com/mutating-webhooks-in-kubernetes-a9ca756c9369)
- [Helm Hooks and it usage](https://medium.com/helm-hooks-and-it-usage-e1d2d2017283)
- [Predictive Autoscaling in Kubernetes with Keda and Prophet](https://medium.com/predictive-autoscaling-in-kubernetes-with-keda-and-prophet-cbccd96cf881)
- [Long list of databases in the CNCF](https://medium.com/long-list-of-databases-in-the-cncf-can-be-intimidating-cfbad839d400)
- [Understanding stdout and stderr in Kubernetes](https://medium.com/understanding-stdout-and-stderr-in-kubernetes-a3a413fbb47b)
- [Kubernetes Namespace Visibility: Building a CRD for Multi-Tenant Clusters](https://medium.com/kubernetes-namespace-visibility-building-a-crd-for-multi-tenant-clusters-5a73e8b04088)
- [Argo CD Sync Waves](https://medium.com/argo-cd-sync-waves-b5c96f707631)
...
- [How to Enforce Terraform Policies for EKS Using OPA](https://medium.com/how-to-enforce-terraform-policies-for-eks-using-opa-in-your-ci-cd-pipeline-985abbdaacb2)
- [Transition from Linux Administrator to Devops Now!](https://medium.com/transition-from-linux-administrator-to-devops-now-a858d8775eb3)
- [Terraform Sentinel](https://medium.com/terraform-sentinel-059b1754c62d)
...
### AWS Services
- [Time-Based EC2 Access with OPA](https://medium.com/time-based-ec2-access-with-opa-enforcing-secure-ssh-access-using-open-policy-agent-ac03ef43102f)
...
- [Choosing the Right Event Pattern & Data Serialization Format](https://medium.com/choosing-the-right-event-pattern-data-serialization-format-65e097435148)
- [Messaging & Communication Protocols in Modern Applications](https://medium.com/messaging-communication-protocols-in-modern-applications-a9b7b236c95b)
- [CloudEvents: The Standard for Event Data in Modern Applications](https://medium.com/cloudevents-the-standard-for-event-data-in-modern-applications-ef0f1383d873)
- [Fan-In and Fan-Out Patterns in Cloud and Distributed Systems](https://medium.com/fan-in-and-fan-out-patterns-in-cloud-and-distributed-systems-0544235b9d6b)
...
- [Different ways to send API Key](https://medium.com/different-ways-to-send-api-key-81c3de85cef5)
- [Understand gRPC: Google Remote Procedure Call](https://medium.com/understand-grpc-google-remote-procedure-call-d7081896a7b7)
- [Power of CORS: Making the Web Safe and Fun for All](https://medium.com/power-of-cors-making-the-web-safe-and-fun-for-all-cb2ccb2ea3a9)
- [Understanding CP Codes and Cache Tags in Global Applications](https://medium.com/understanding-cp-codes-and-cache-tags-in-global-applications-3961a484449d)
...
- [Organize Your Saved "Medium" Articles with MkDocs](https://medium.com/organize-your-saved-medium-articles-with-mkdocs-e6b92107ba48)
- [Why Switch To MkDocs for Notes?](https://medium.com/why-switch-to-mkdocs-for-notes-489cccdb48b8)
...
- [Oracle is News. How is it different from SQL?](https://medium.com/oracle-is-news-how-is-it-different-from-sql-8614a62f04f0)
- [Optimizing Postgres with Partial Indexes](https://medium.com/optimizing-postgres-with-partial-indexes-real-world-use-cases-and-trade-offs-281576cde9f3)

### SQL & Database Concepts
- [Master SQL Joins: Broadcast Join Vs Bucket Join](https://medium.com/master-sql-joins-broadcast-join-vs-bucket-join-90bf4a51b910)
- [Database Sharding in OLAP and OLTP systems](https://medium.com/database-sharding-in-olap-and-oltp-systems-602276aae66e)
- [SQL Functions You Must Know!](https://medium.com/become-sql-hero-functions-every-data-engineer-should-know-4502dbeb08d7)
- [SQL Joins Cheatsheet](https://medium.com/sql-joins-cheatsheet-b88e90ae64cf)
- [SQL Partition Pruning](https://medium.com/sql-partition-pruning-4721caf30946)

### Data Engineering
- [Understanding DAG in Airflow](https://medium.com/understanding-dag-in-airflow-07b4cf8273ed)
- [The Evolution of Big Data Processing: From Hadoop to Spark to Flink](https://medium.com/the-evolution-of-big-data-processing-from-hadoop-to-spark-to-flink-fb2c8616da63)
...
- [Client-Side Rendering Vs Server-Side Rendering](https://medium.com/client-side-rendering-vs-server-side-rendering-ce5db408291c)
